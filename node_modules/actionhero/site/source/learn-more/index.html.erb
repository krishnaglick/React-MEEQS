        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <p>ActionHero is a multi-transport Node.JS API Server with integrated cluster capabilities and delayed tasks.</p>
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="companyContanier">
                ...
                <a target="_blank" href="http://www.ca.com">
                    <img class="comanyLogo" src="/images/companies/ca.png" alt="CA Technologies" />
                </a>
