...
exports.useVerticalAlignProp = exports.useTextAlignProp = exports.useColumnsProp = exports.useKeyOrValueAndKey = exports.useValueAndKey = exports.useKeyOnly = undefined;
 ...
 */
var useColumnsProp = exports.useColumnsProp = function useColumnsProp(val) {
  var canEqual = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
  return val === 'equal' && canEqual ? 'equal width' : useValueAndKey((0, _numberToWord.numberToWord)(val), 'column');
};
