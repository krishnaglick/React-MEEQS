...
var _Meta = require('../../utils/Meta.js');
    ...
    value: function render() {
      ...
      if (this.props.evenlyDivided) {
        _react.Children.forEach(this.props.children, function (child) {
          if ((0, _get3.default)(child, 'type._meta.name') === 'FormField') {
            fieldCount += 1;
          }
        });
      }

      var classes = (0, _classnames2.default)(this.props.className, (0, _numberToWord2.default)(fieldCount), 'fields');
      var props = (0, _propUtils.getUnhandledProps)(FormFields, this.props);
