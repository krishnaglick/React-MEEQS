...
function GridColumn(props) {
  ...
  var classes = (0, _classnames2.default)(className, color, (0, _lib.useValueAndKey)((0, _lib.numberToWord)(computer), 'wide computer'), (0, _lib.useValueAndKey)(floated, 'floated'), (0, _lib.useValueAndKey)((0, _lib.numberToWord)(largeScreen), 'wide large screen'), (0, _lib.useValueAndKey)((0, _lib.numberToWord)(mobile), 'wide mobile'), (0, _lib.useValueAndKey)(only, 'only'), (0, _lib.useValueAndKey)((0, _lib.numberToWord)(tablet), 'wide tablet'), (0, _lib.useTextAlignProp)(textAlign), (0, _lib.useVerticalAlignProp)(verticalAlign), (0, _lib.useValueAndKey)((0, _lib.numberToWord)(widescreen), 'wide widescreen'), (0, _lib.useValueAndKey)((0, _lib.numberToWord)(width), 'wide'), 'column');
