...
var Modal = function (_Component) {
  ...
  function Modal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Modal)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this.onHide = function () {
      debug('onHide()');
      ...
      if (_this._modalNode.contains(e.target)) return;
