...
var _keyboardKey = require('../../utils/keyboardKey');
...
var debug = (0, _debug.makeDebugger)('dropdown');
...
var Dropdown = function (_Component) {
  ...
  function Dropdown() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Dropdown)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.onChange = function (e, value) {
      ...
      debug(_keyboardKey2.default.getName(e));
      switch (_keyboardKey2.default.getCode(e)) {
        case _keyboardKey2.default.ArrowDown:
          e.preventDefault();
          _this.moveSelectionBy(1);
          break;
        case _keyboardKey2.default.ArrowUp:
          e.preventDefault();
          _this.moveSelectionBy(-1);
          break;
        default:
      ...
      if (_keyboardKey2.default.getCode(e) !== _keyboardKey2.default.Spacebar) return;
      ...
      var code = _keyboardKey2.default.getCode(e);
      if (!(0, _includes3.default)([_keyboardKey2.default.ArrowDown, _keyboardKey2.default.ArrowUp], code)) return;
      if (_this.state.open) return;
      e.preventDefault();
      // TODO open/close should only change state, open/closeMenu should be called on did update
      _this.trySetState({ open: true });
      ...
      debug(_keyboardKey2.default.getName(e));
      if (_keyboardKey2.default.getCode(e) !== _keyboardKey2.default.Enter) return;
      e.preventDefault();
      ...
      debug(_keyboardKey2.default.getName(e));
      if (_keyboardKey2.default.getCode(e) !== _keyboardKey2.default.Backspace) return;
      ...
      var selectedIndex = _this$state4.selectedIndex;
  ...
  _createClass(Dropdown, [{
    ...
    value: function componentWillMount() {
      if (_get(Object.getPrototypeOf(Dropdown.prototype), 'componentWillMount', this)) _get(Object.getPrototypeOf(Dropdown.prototype), 'componentWillMount', this).call(this);
    ...
    value: function componentWillReceiveProps(nextProps) {
      _get(Object.getPrototypeOf(Dropdown.prototype), 'componentWillReceiveProps', this).call(this, nextProps);
      debug('componentWillReceiveProps()');
      // TODO objectDiff still runs in prod, stop it
      debug('changed props:', (0, _utils.objectDiff)(nextProps, this.props));
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      // TODO objectDiff still runs in prod, stop it
      debug('changed state:', (0, _utils.objectDiff)(this.state, prevState));
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)('ui', dropdownClasses, (0, _propUtils.useKeyOnly)(disabled, 'disabled'), (0, _propUtils.useKeyOnly)(error, 'error'), (0, _propUtils.useKeyOnly)(loading, 'loading'), (0, _propUtils.useKeyOnly)(button, 'button'), (0, _propUtils.useKeyOnly)(compact, 'compact'), (0, _propUtils.useKeyOnly)(fluid, 'fluid'), (0, _propUtils.useKeyOnly)(floating, 'floating'), (0, _propUtils.useKeyOnly)(inline, 'inline'), (0, _propUtils.useKeyOnly)(icon, 'icon'), (0, _propUtils.useKeyOnly)(labeled, 'labeled'),
      // TODO: linkItem is required only when Menu child, add dynamically
      (0, _propUtils.useKeyOnly)(linkItem, 'link item'), (0, _propUtils.useKeyOnly)(multiple, 'multiple'), (0, _propUtils.useKeyOnly)(search, 'search'), (0, _propUtils.useKeyOnly)(selection, 'selection'), (0, _propUtils.useKeyOnly)(simple, 'simple'), (0, _propUtils.useKeyOnly)(scrolling, 'scrolling'), (0, _propUtils.useKeyOrValueAndKey)(pointing, 'pointing'), className, 'dropdown');
      ...
      var rest = (0, _propUtils.getUnhandledProps)(Dropdown, this.props);
...
Dropdown.propTypes = {
  ...
  options: _propUtils.customPropTypes.all([_propUtils.customPropTypes.mutuallyExclusive(['children']), _propUtils.customPropTypes.require(['selection']), _react.PropTypes.arrayOf(_react.PropTypes.shape({
  ...
  children: _propUtils.customPropTypes.all([_propUtils.customPropTypes.mutuallyExclusive(['options', 'selection']), _propUtils.customPropTypes.require(['text']), _react2.default.PropTypes.element, _propUtils.customPropTypes.ofComponentTypes(['DropdownMenu'])]),
  ...
  selection: _propUtils.customPropTypes.all([_propUtils.customPropTypes.mutuallyExclusive(['children']), _propUtils.customPropTypes.require(['options']), _react.PropTypes.bool]),
