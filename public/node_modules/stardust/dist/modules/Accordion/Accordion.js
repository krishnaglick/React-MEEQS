...
var Accordion = function (_Component) {
  ...
  function Accordion() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Accordion)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this.handleTitleClick = function (e, index) {
  ...
  _createClass(Accordion, [{
    ...
    value: function componentWillMount() {
      _get(Object.getPrototypeOf(Accordion.prototype), 'componentWillMount', this).call(this);
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)(className, 'ui', (0, _lib.useKeyOnly)(fluid, 'fluid'), (0, _lib.useKeyOnly)(inverted, 'inverted'), (0, _lib.useKeyOnly)(styled, 'styled'), 'accordion');
...
Accordion.propTypes = {
  ...
  children: _lib.customPropTypes.every([_lib.customPropTypes.disallow(['panels']), _react.PropTypes.node]),
